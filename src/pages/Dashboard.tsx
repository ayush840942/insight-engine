...
const Dashboard = () => {
  ...
  const stats = [
    { title: "Apps Analyzed", icon: BarChart3, value: appCount.toString(), color: "text-primary" },
    { title: "Avg Score", icon: TrendingUp, value: avgScore, color: "text-primary" },
    { title: "Issues Found", icon: AlertTriangle, value: issueCount.toString(), color: "text-destructive" },
    { title: "Opportunities", icon: Sparkles, value: oppCount.toString(), color: "text-accent" },
  ];
        ...
        >
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold font-display capitalize">{plan} Plan</span>
            </div>
            <Button
              variant="outline"
              size="sm"
              onClick={() => navigate("/dashboard/upgrade")}
              className="text-primary border-primary/30 hover:bg-primary/10 rounded-xl"
            >
              Upgrade
            </Button>
          </div>
