...
const plans = [
  {
    ...
    features: ["2 analyses per month", "Basic report", "Email support"],
    cta: "Get Started",
    highlighted: false,
  },
  {
    ...
    features: ["50 analyses", "Full reports", "Review intelligence", "Growth plans", "Priority support"],
  ...
  },
  {
    ...
    features: ["200 analyses", "All features", "Competitor analysis", "Monetization insights", "Export reports", "API access"],
    cta: "Start Free Trial",
    highlighted: true,
  },
  {
    ...
    features: ["1000 analyses", "Team accounts", "White-label reports", "Advanced analytics", "Custom integrations", "Dedicated support"],
    cta: "Contact Sales",
    highlighted: false,
  },
];
